                ...
                <tbody >
                    {dados.map((log, index) => (
                        <tr key={index} className="even:bg-gray-100 hover:bg-gray-200">
                            <td className="py-2 px-4 font-semibold text-wrap ">{log.action}</td>
                            <td className="py-2 px-4 font-semibold text-wrap ">{log.createdAt}</td>
                            <td className=" truncate max-w-full font-semibold text-wrap line-clamp-1 overflow-hidden">{log.response}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
